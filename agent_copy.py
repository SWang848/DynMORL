...
class DeepAgent():
    ...
    def policy_update(self, current_state):
    ...
    def train(self, environment, log_file, learning_steps, weights,
        ...
        for i in range(int(self.total_steps)):
            ...
            loss = self.perform_updates(i, current_state)
    ...
    def perform_updates(self, steps, current_state):
        ...
        if steps > self.min_buf_size * self.learning_steps:
            ...
            if steps % self.update_interval == 0:
                ...
                loss = self.policy_update(current_state)
